...
```txt
last_run: 2026-07-02T22:53:56+04:00
...
projects:
  ...
  project[DB]: RESULT: RED  (problems=7, warnings=0) (exit=2, registry-status=RETIRED, consumer-only L10)
  project[GAA]: RESULT: GREEN  (problems=0, warnings=0) (exit=0, registry-status=INSTALLED, consumer-only L10)
  project[SCOUT]: RESULT: GREEN  (problems=0, warnings=0) (exit=0, registry-status=INSTALLED, consumer-only L10)
  project[MENQ]: RESULT: GREEN  (problems=0, warnings=0) (exit=0, registry-status=INSTALLED, consumer-only L10)
