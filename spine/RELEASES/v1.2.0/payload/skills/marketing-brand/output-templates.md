# Marketing and Brand output templates

## English

Three domain-shaped deliverables. Fill the real fields; keep every number traceable to funnel math or a named source. Do not invent CACs, benchmarks, or market sizes — show the formula or mark the input verify-before-use.

### Template 1 — Positioning brief (the five Dunford components)

- **Competitive alternatives:** what the buyer does without you (often a spreadsheet, a manual process, or "nothing")
- **Unique attributes:** capabilities you have that the alternatives lack
- **Value:** the benefit those attributes enable, in the buyer's terms (not the feature)
- **Target-market characteristics:** the buyers who care about that value most (your best-fit segment)
- **Market category:** the frame of reference that makes the value obvious
- **Proof per claim:** named source for each value claim (pilot benchmark / case / mechanism) — verify-at-scale flag where pilot-only
- **"Why now" (sales narrative, NOT positioning):** the urgency for the pitch, kept out of the five components
- **Message comprehension gate:** the promise buyers must be able to repeat before preference is tested
- **Acceptance:** five components present · "why now" excluded from positioning · positioned against the real alternative · every claim has a named proof

### Template 2 — Demand-generation plan

- **Objective & motion:** the outcome; motion fit (broad demand-gen / ABM 1:1·1:few·1:many / PLG) chosen by ACV and account count
- **Funnel-stage × intent matrix:**
...
- **Decision the measurement must serve:** (allocation / scale a channel / prove a channel creates demand)
...
Երեք domain-ձև deliverable։ Լրացրու իրական field-երը. ամեն թիվ պահիր հետագծելի funnel math-ի կամ անվանված source-ի։ Մի՛ հորինիր CAC, benchmark կամ market size — ցույց տուր formula-ն կամ նշիր input-ը verify-before-use։

### Template 1 — Positioning brief (Dunford-ի հինգ բաղադրիչ)

- **Competitive alternatives․** ինչ է անում buyer-ն առանց քեզ (հաճախ spreadsheet, ձեռքի process կամ «ոչինչ»)
- **Unique attributes․** կարողություններ, որ դու ունես, իսկ alternative-ները՝ ոչ
- **Value․** այն օգուտը, որ այդ attribute-ները հնարավոր են դարձնում, buyer-ի լեզվով (ոչ feature-ը)
- **Target-market characteristics․** այն buyer-ները, որ այդ value-ն ամենից շատ են կարևորում (քո best-fit segment)
- **Market category․** frame of reference-ը, որ value-ն ակնհայտ է դարձնում
- **Proof ամեն claim-ի․** անվանված source ամեն value claim-ի (pilot benchmark / case / mechanism) — verify-at-scale flag, որտեղ pilot-only է
- **«Why now» (sales narrative, ՈՉ positioning)․** urgency-ն pitch-ի համար, պահված հինգ բաղադրիչից դուրս
- **Message comprehension gate․** այն promise-ը, որ buyer-ը պետք է կարողանա կրկնել, նախքան preference-ի test-ը
- **Acceptance․** հինգ բաղադրիչ կա · «why now»-ը positioning-ից դուրս է · positioned է իրական alternative-ի դեմ · ամեն claim ունի անվանված proof

### Template 2 — Demand-generation plan

- **Objective & motion․** outcome-ը. motion fit (broad demand-gen / ABM 1:1·1:few·1:many / PLG) ընտրված ACV-ով և account-ների քանակով
- **Funnel-stage × intent matrix․**
  - TOFU / informational — content + answer-engine/SEO (demand creation + capture)
  - MOFU / commercial — comparison/guide/webinar + email nurture (trigger → goal → exit)
...
- **Որոշումը, որ measurement-ը պետք է սպասարկի․** (allocation / channel scale / ապացուցել, որ channel-ը demand է ստեղծում)
