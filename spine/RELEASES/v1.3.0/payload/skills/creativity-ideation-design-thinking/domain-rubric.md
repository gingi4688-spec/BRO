# Creativity, Ideation, and Design Thinking domain rubric
...
| Learning loop | Ideas end in list. | Next step named. | Experiment, learning metric, owner, and kill/continue rule are explicit. |
...
| Learning loop | Idea-ները ավարտվում են list-ով։ | Next step կա։ | Experiment-ը, learning metric-ը, owner-ը և kill/continue rule-ը բաց են։ |
